...
interface EditWhatToExpectProps {
  open: boolean;
  onOpenChange: (open: boolean) => void;
}

export default function EditWhatToExpect({
  open,
  onOpenChange,
}: EditWhatToExpectProps) {
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div className="bg-blue-50 border border-blue-200 rounded-xl p-4">
                <p className="text-sm text-gray-700">
                  <span className="font-semibold text-blue-700">Visual editor for What to Expect coming soon!</span>
                </p>
